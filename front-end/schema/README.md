This directory contains the [JSON Schemas](http://json-schema.org/) used by the Unified Listing, as well as a convenience library for working with schemas from within express.
